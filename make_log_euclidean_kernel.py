...
# set directories
data_dir = '/home/jonyoung/IoP_data/Data/connectivity_data/KCL_SC2/matrix_unsmooth/'
kernel_dir = '/home/jonyoung/IoP_data/Data/connectivity_data/KCL_SC2/kernels/'
...
for i in range(9, 10) :
    ...
    for j in range(8, 10) :
        ...
        np.savetxt(kernel_dir + 'K_log_euclidean_' + str(i) + '_' + str(j) + '_2.csv', K, delimiter=',')
