# -*- coding: utf-8 -*-
"""
Created on Tue Jul 12 12:01:15 2016
...
def repeated_k_cv(data, labels, classifier, repeats, k, metric) :
    ...
    for i in range(repeats) :
        ...
        score = cross_validation.cross_val_score(classifier, rep_K, rEventep_labels - 1, cv=k, scoring=metric)
...
for i in range(2, 8) :
    ...
    results[i-2, :]= n_subjects_results
